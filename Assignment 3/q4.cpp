...
class Matrix{
    ...
    public:
        Matrix(){
            ...
            this->matrixPtr = new int*[3];
            this->numberOfRows = 3;
            for(int i=0; i<3; i++){
                this->matrixPtr[i] = new int[3];
        ...
        Matrix(int row, int col){
            this->matrixPtr = new int*[row];
            this->numberOfRows = row;
            for(int i=0; i<row; i++){
                this->matrixPtr[i] = new int[col];
...
enum menu{
    EXIT, PrintMatrix, AcceptMatrix, AdditionOfTwoMatrices, SubtractionOfTwoMatrices, MultiplicationOfTwoMatrices, TransposeOfMatrix
};
